...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--epoch", type=int, default=50, help="Epoch number for Training."
    )
    ...
    parser.add_argument(
        "--inference_sample_num", type=int, default=1000, help="inference samples"
    )
    ...
    parser.add_argument(
        "--drug_index", type=str, default="DrugGEN/data/drug_smiles.index"
    )
    ...
    parser.add_argument(
        "--model_save_dir", type=str, default="DrugGEN/experiments/models"
    )
    ...
    parser.add_argument(
        "--result_dir", type=str, default="DrugGEN/experiments/tboard_output"
    )
    ...
    parser.add_argument(
        "--drug_raw_file", type=str, default="DrugGEN/data/akt_train.smi"
    )
    ...
    parser.add_argument(
        "--inf_raw_file", type=str, default="DrugGEN/data/chembl_test.smi"
    )

    parser.add_argument(
        "--inf_drug_raw_file", type=str, default="DrugGEN/data/akt_test.smi"
    )
